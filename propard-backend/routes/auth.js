...
// Supprime les données personnelles mais garde les messages avec "Utilisateur supprimé"
router.delete('/anonymize', authMiddleware, async (req, res) => {
  try {
    const userId = req.user.id;

    // Anonymise le compte : remplace le pseudo par "Utilisateur supprimé"
    // et efface les données sensibles
    ...
    // Retire cet utilisateur des listes d'amis de tout le monde
...
// Supprime tout : compte, amis, messages
